...
const signalOptions: { id: SignalSourceType; label: string; hint: string; emoji: string }[] = [
  {
    id: "recruiter_email",
    label: "Recruiter text/email",
    hint: "Paste it. We read the play for you.",
    emoji: "📨",
  },
  { id: "job_link", label: "Job link", hint: "Drop the link. We pull the key facts.", emoji: "🔗" },
  {
    id: "job_text",
    label: "Job text",
    hint: "Paste the role write-up. We clean it up.",
    emoji: "📝",
  },
  {
    id: "transcript",
  ...
  { id: "note", label: "Quick note", hint: "Rough notes are fine. We shape it.", emoji: "⚡" },
];
  ...
  return (
    <PageTemplate
      ...
      header={{
        ...
        description:
          "Drop the messy receipt, DM, link, or transcript. We sort it, label it, and point you at the next checkpoint.",
        actions: (
          <button
        ...
        panel: (
          <div className="toy-surface rounded-[2rem] border border-black/5 bg-white/80 shadow-brand-shadow p-6 lg:p-7">
            ...
            <p className="text-base text-brand-ink leading-relaxed mt-3">
              Start with the signal, not the paperwork. We infer the structure before we ask you to
              lock anything in.
            </p>
            <div className="space-y-4 mt-5">
              ...
              <div className="border-t border-black/8 pt-4">
                ...
                <p className="text-sm text-brand-ink mt-2 leading-relaxed">
                  Company, role, and the next move ready for a quick yes.
                </p>
              </div>
            </div>
          </div>
    ...
    >
      <section className="grid grid-cols-1 xl:grid-cols-[320px_minmax(0,1fr)] gap-6 items-start">
        <div className="toy-surface rounded-[2rem] border border-black/5 bg-white/60 shadow-brand-shadow p-5 lg:p-6">
        ...
        <form
          ...
          className="onboarding-grid toy-surface rounded-[2rem] border border-black/5 bg-white/60 shadow-brand-shadow p-6 sm:p-8 lg:p-9 flex flex-col gap-6"
        >
          <div className="flex flex-wrap items-center gap-3">
            <span className="sticker-badge animate-sticker-spin">
              {activeOption.emoji} active drop
            </span>
            <span className="sticker-badge">step 1 of 3 🛼</span>
          </div>
          ...
          <div>
            ...
            <h2 className="text-2xl lg:text-[2rem] font-bold tracking-[-0.04em] text-brand-ink">
              {activeOption.emoji} {activeOption.label}
            </h2>
          ...
          <div className="flex flex-wrap gap-4 items-center">
            ...
            <p className="text-xs text-brand-muted">
              We auto-fill the draft and send you to a quick ready check.
            </p>
          </div>
        </form>
      </section>
