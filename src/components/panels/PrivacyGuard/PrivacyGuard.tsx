  ...
  return (
    <div className="flex items-start gap-4 p-4 lg:p-5 rounded-[1.5rem] bg-brand-ink text-white shadow-brand-shadow" aria-live="polite">
      ...
      <div className="min-w-0">
        <p className="m-0 text-[10px] font-bold uppercase tracking-[0.18em] text-white/70">Your stash</p>
        <p className="m-0 mt-1 font-bold leading-tight text-base">Local mode on.</p>
        <p className="m-0 mt-2 text-[0.82rem] opacity-90 leading-relaxed">
          Your data stays <strong className="font-bold">{storageType}ly</strong> in this browser unless you export it.
        </p>
      </div>
    </div>
  );
