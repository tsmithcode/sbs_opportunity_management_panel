...
export const CoachingSection: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-5 p-6 sm:p-8 lg:p-9 rounded-[2rem] bg-white/60 border border-black/5 shadow-brand-shadow">
      <div>
        <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-brand-muted mb-2">Optional tips</p>
        <h3 className="text-2xl lg:text-[2rem] font-bold tracking-[-0.04em] text-brand-ink">Stage tips if you want them</h3>
      </div>
      ...
      <div className="space-y-4">
        ...
        <details className="rounded-[1.5rem] border border-black/10 bg-brand-surface px-5 py-4">
          <summary className="cursor-pointer text-sm font-semibold text-brand-ink">Street glossary</summary>
        ...
        <details className="rounded-[1.5rem] border border-black/10 bg-brand-surface px-5 py-4">
          <summary className="cursor-pointer text-sm font-semibold text-brand-ink">Game context</summary>
          <div className="grid gap-3 mt-4">
